...
@section('content')
    <div class="img p-3 mt-2 row">
        <div class="col-5">
            <p class="d-inline">همه منو ها : </p><span class="d-inline">6</span>
        </div>
        <div class="col-7">
    ...
    <div class="img p-3 row">
        <div class="col">
            ...
            <button class="btn btn-outline-warning" type="button"> اعمال</button>
             <a  href="{{route('admin.content.menu.create')}}"> <button class="btn btn-outline-success" type="button">ایجاد منو جدید </button></a>
        </div>
        <div class="col ">
            ...
            <table class="table table-striped table-dark text-white table-hover">
                ...
                @foreach ($menus as $key => $menu)
                    <tr>
                        ...
                        <td style="font-size: 25px"> <span><a href="{{ route('admin.content.menu.edit', $menu->id) }}"><i class="las la-edit"></i></a></span>
