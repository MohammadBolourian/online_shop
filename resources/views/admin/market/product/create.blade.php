...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">اضافه کردن کالا </li>
@endsection
...
@section('content')
    <div class="col-12">
        ...
        <form class="form-group row " action="{{ route('admin.market.product.store') }}" method="POST" enctype="multipart/form-data" id="form">
            @csrf
           <div class="col-6 mt-5">
            ...
            <div class="col-6 mt-5">
                ...
                <input name="inventory" type="text" class="form-control " value="{{ old('inventory') }}">
                @error('inventory')
                <span class=" bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                                        {{ $message }}
            ...
            <div class="mt-5 mr-4">
                <button class="btn btn-outline-success ml-3" type="submit">افزودن</button>
