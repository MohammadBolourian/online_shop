    ...
    <div class="img p-3 row">
        <div class="col">
            ...
            <button class="btn btn-outline-warning" type="button"> اعمال</button>
             <a  href="{{route('admin.content.category.create')}}"> <button class="btn btn-outline-success" type="button">ایجاد دسته جدید </button></a>
        </div>
        <div class="col ">
...
{{--                        <img src="{{ asset($postCategory->image['indexArray'][$postCategory->image['currentImage']] ) }}" alt="" width="100" height="50">--}}
                    ...
                    <td style="font-size: 25px"> <span><a href="{{ route('admin.content.category.edit', $postCategory->id) }}"><i class="las la-edit"></i></a></span>
