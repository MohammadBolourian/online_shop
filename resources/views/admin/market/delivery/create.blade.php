            ...
            <section class="row">
                ...
                <section class="col-12 col-md-6 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="delivery_time" id="delivery_time" value="{{ old('delivery_time') }}">
                    </div>
                    @error('delivery_time')
                    <span class="bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                ...
                <section class="col-12 col-md-6 my-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="delivery_time_unit" id="delivery_time_unit" value="{{ old('delivery_time_unit') }}">
                    </div>
