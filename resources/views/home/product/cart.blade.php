            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered m-0">
                        ...
                        <tbody>
                        @php $x=0; @endphp
                        @foreach(\Cart::instance('cart-mamalkala')->all() as $cart)
                            @if(isset($cart['product']))
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle p-4">
                                        <select onchange="changeQuantity(event, '{{ $cart['id'] }}' , 'cart-mamalkala')" class="form-control text-center">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
                    @if($discount = Cart::getDiscount())
                        <div class="mt-4">
{{--                            =======================================================================================================--}}
                            <form action="{{route('cart.discount.destroy')}}" method="post" id="delete-discount">
                                @method('delete')
                                @csrf
                                <input type="hidden" name="cart" value="cart-mamalkala">
                            </form>
