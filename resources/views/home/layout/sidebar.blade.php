    ...
    <ul class="nav flex-column right-side">
     ...
     @can('blog-manager')
        ...
        <li class="nav-item">
            ...
            <ul class="zir-menu">
                <li>
                    <a class="nav-link" href="{{route("admin.market.order.all")}}"><i class="sub-icon-right ml-1 las la-book-open"></i><span class="hide-show">مشاهده تمامی سفارشات</span></a>
                </li>
                <li>
                    <a class="nav-link" href=""><i class="sub-icon-right ml-1 las la-pen"></i> <span class="hide-show">جدید</span></a>
                </li>
                <li>
                    <a class="nav-link" href=""><i class="sub-icon-right ml-1 las la-cart-plus"></i> <span class="hide-show"> در حال ارسال</span></a>
                </li>
                <li>
                    <a class="nav-link" href=""><i class="sub-icon-right ml-1 las la-cart-plus"></i> <span class="hide-show"> پرداخت شده</span></a>
                </li>
                <li>
                    <a class="nav-link" href=""><i class="sub-icon-right ml-1 las la-cart-plus"></i> <span class="hide-show">باطل شده </span></a>
                </li>
                <li>
                    <a class="nav-link" href=""><i class="sub-icon-right ml-1 las la-cart-plus"></i> <span class="hide-show">مرجوعی </span></a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
        ...
        @can('shop-manager')
        <li class="nav-item">
            <a class="nav-link nav-edit" href="#"><i class="icon-right ml-1 las la-flushed"></i><span class="hide-show">تخفیف ها </span></a>
            <ul class="zir-menu">
                <li>
                    <a class="nav-link" href="{{route('admin.market.discount.copan')}}"><i class="sub-icon-right ml-1 las la-list"></i><span class="hide-show"> کد تخفیف</span></a>
                </li>
                <li>
                    <a class="nav-link" href="{{route('admin.market.discount.commonDiscount')}}"><i class="sub-icon-right ml-1 las la-bars"></i> <span class="hide-show">تخفیف عمومی</span></a>
                </li>
                <li>
                    <a class="nav-link" href="{{route('admin.market.discount.amazingSale')}}"><i class="sub-icon-right ml-1 las la-bars"></i> <span class="hide-show">فروش شگفت انگیز </span></a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
